                ...
                <div className="card-body">
                    <div className="flex flex-row">
                        <div>
                            ...
                            <input className="mt-2 mb-2 input input-bordered w-full max-w-xs" type="text" name="firstName" value="John"></input>
                        </div>
                        <div>

                            <label className="mt-2 mb-2">Last Name</label>
                            <input className="mt-2 mb-2 input input-bordered w-full max-w-xs" type="text" name="lastName" value="Doe"></input>
                        </div>
                    </div>
                    <div className="">
                        Email
